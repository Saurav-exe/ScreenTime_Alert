...
def track_screen_time():
    reminder_interval = 20 * 60 * 1000  # 20 minutes in milliseconds
    show_custom_alert()  # Show alert now
    root.after(reminder_interval, track_screen_time)  # Schedule the next alert
